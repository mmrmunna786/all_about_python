...
# print( divide(10, 'a') )  # "Both inputs must be numbers!"
...
def divide( num1, num2 ):
    ...
    # If you pass as the second argument a 0, Python will raise a ZeroDivisionError, so if this function is invoked with a 0 as the 
